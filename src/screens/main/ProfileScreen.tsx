    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>
          <Image source={assets.icons.profileScreen.back} style={styles.backIcon} />
        </TouchableOpacity>
        <Typography variant="h4" style={styles.headerTitle}>Profile</Typography>
      </View>

      <View style={styles.userInfo}>
  <Image source={require('../../../assets/icons/image 1.png')} style={styles.avatar} />
  <Typography variant="h5" style={styles.userName}>Vishal Khadok</Typography>
</View>
